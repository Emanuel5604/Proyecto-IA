...
class EyeBrowsPointsProcessing:
    ...
    def main(self, eyebrows_points: dict):
        ...
        right_eyebrow_arch = self.arch_calculator.calculate_eyebrow_arch(
            eyebrows_points['right arch'])
        left_eyebrow_arch = self.arch_calculator.calculate_eyebrow_arch(
            eyebrows_points['left arch'])
