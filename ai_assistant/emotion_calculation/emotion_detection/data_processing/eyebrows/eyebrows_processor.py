...
from emotion_detection.data_processing.eyebrows.eyebrows_processing import (EyeBrowsPointsProcessing,
...
class EyeBrowsProcessor(FeatureProcessor):
    def __init__(self):
        ...
        self.processor = EyeBrowsPointsProcessing(
            arch_calculator, distance_calculator)
