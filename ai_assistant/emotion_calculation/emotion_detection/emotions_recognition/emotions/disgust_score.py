from emotion_detection.emotions_recognition.features.weights_emotion_score import WeightedEmotionScore


class DisgustScore(WeightedEmotionScore):
    def __init__(self):
        super().__init__(eyebrows_weight=0.25, eyes_weight=0.25,
                         nose_weight=0.35, mouth_weight=0.15)
