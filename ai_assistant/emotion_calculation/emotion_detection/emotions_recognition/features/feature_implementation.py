from emotion_detection.emotions_recognition.features.feature_check import (EyebrowsCheck, EyesCheck, NoseCheck,
                                                                           MouthCheck)
...
class BasicEyebrowsCheck(EyebrowsCheck):
    def check_eyebrows(self, eyebrows: dict) -> str:
        ...
        eyebrows_distance, forehead_distance = eyebrows[
            'eyebrows_distance'], eyebrows['eyebrow_distance_forehead']
        ...
        results.append('right eyebrow: raised' if eye_right >
                       forehead_right else 'right eyebrow: lowered')
        results.append('left eyebrow: raised' if eye_left >
                       forehead_left else 'left eyebrow: lowered')
...
class BasicEyesCheck(EyesCheck):
    def check_eyes(self, eyes: dict) -> str:
        ...
        left_eyelid_upper, left_eyelid_lower = eyes[
            'left_upper_eyelid_distance'], eyes['left_lower_eyelid_distance']

        results = ['open eyes' if right_eyelid_upper >
                   right_eyelid_lower else 'closed eyes']
...
class BasicMouthCheck(MouthCheck):
    def check_mouth(self, mouth: dict) -> str:
        ...
        results.append('right smile' if right_lip >
                       right_smile else 'no right smile')
        results.append('left smile' if left_lip >
                       left_smile else 'no left smile')
