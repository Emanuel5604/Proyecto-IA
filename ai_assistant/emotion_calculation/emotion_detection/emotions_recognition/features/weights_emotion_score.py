...
from emotion_detection.emotions_recognition.features.emotion_score import EmotionScore
from emotion_detection.emotions_recognition.features.feature_implementation import (BasicEyebrowsCheck, BasicEyesCheck,
...
class WeightedEmotionScore(EmotionScore, ABC):
    ...
    def calculate_score(self, features: dict) -> dict:
        eyebrows_result = self.eyebrows_check.check_eyebrows(
            features['eyebrows'])
